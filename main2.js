...
require("./content2"); // 假设这个文件定义了全局变量 content
...
const scripts = [
    ...
    {
        type: "text/javascript", r: 'm',
        src: "/fpqQrgG7L6po/15QqdX9S7nDE.294cc83.js",
        parentElement: {
...
// 模拟 a 标签
const a1 = {
    href: "/datasearch/data/nmpadata/search",
    protocol: "https:",
    host: "www.nmpa.gov.cn",
    pathname: "/datasearch/data/nmpadata/search",
    port: '443',
...
function get_curr(_url) {
    ...
    // 直接创建实例并调用 open 方法，这将触发我们定义的 prototype.open 逻辑
    const g = new XMLHttpRequest();
    g.open("GET", path, true);
    // 我们的模拟 open 函数会修改全局变量 req_param，这里直接返回它即可
    console.log('Original Request URL:', _url);
    console.log('Modified Request Param:', req_param);
    return req_param;
}